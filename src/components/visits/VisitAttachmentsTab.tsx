  ...
  return (
    <div className="space-y-5">
      ...
      {visitStatus !== "CANCELLED" && (
        <div className="border-2 border-dashed border-pk-border rounded-xl p-6 text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <label className="cursor-pointer bg-pk-teal-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-pk-teal-700 transition">
              Browse File
      ...
      {attachments.length === 0 ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {attachments.map((att) => (
            <div key={att.id} className="border border-pk-border rounded-xl p-3 text-center relative group">
              {att.mimeType.startsWith("image/") ? (
                ...
                <div className="w-full h-24 bg-pk-surface-sunken rounded-lg flex items-center justify-center mb-2">
