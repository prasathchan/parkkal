  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pk-neutral-50 to-pk-teal-50 flex items-start justify-center py-16 px-4">
      <div className="w-full max-w-2xl">
        ...
        {/* Component list */}
        <div className="bg-white rounded-2xl shadow-sm border border-pk-border divide-y divide-pk-border mb-6">
          {[
        ...
        {/* SLA commitment */}
        <div className="bg-white rounded-2xl shadow-sm border border-pk-border p-6 mb-6">
        ...
        {/* Incident contact */}
        <div className="bg-white rounded-2xl shadow-sm border border-pk-border p-6">
