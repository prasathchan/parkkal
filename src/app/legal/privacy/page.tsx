    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-12">
        <nav className="text-sm text-slate-500 mb-8">
          <Link href="/" className="hover:text-slate-700">Parkkal</Link>
        ...
        <div className="prose prose-slate max-w-none text-sm leading-relaxed space-y-8">
          ...
          <section>
            ...
            <p className="text-slate-600 mt-2">
              For privacy enquiries: <a href="mailto:privacy@parkkal.com" className="text-blue-600 hover:underline">privacy@parkkal.com</a>
            </p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">2. Information We Collect</h2>
            <p className="text-slate-600 mb-2"><strong>About clinic staff (Account Data):</strong></p>
            ...
            <p className="text-slate-600 mt-3 mb-2"><strong>About patients (Clinical Data — processed on behalf of the clinic):</strong></p>
            <ul className="list-disc pl-5 text-slate-600 space-y-1">
            ...
            <p className="text-slate-600 mt-3 mb-2"><strong>Automatically collected:</strong></p>
            <ul className="list-disc pl-5 text-slate-600 space-y-1">
          ...
          <section>
            ...
            <p className="text-slate-600 mt-2">We do not sell personal data. We do not use patient data for advertising.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">4. Legal Basis for Processing</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">5. Data Storage and Security</h2>
            <p className="text-slate-600">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm border border-slate-200 rounded-lg overflow-hidden">
                <thead className="bg-slate-50">
                  <tr>
                    <th className="text-left px-4 py-2 font-medium text-slate-700">Sub-processor</th>
                    <th className="text-left px-4 py-2 font-medium text-slate-700">Purpose</th>
                    <th className="text-left px-4 py-2 font-medium text-slate-700">Data Location</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100">
                  <tr>
                    <td className="px-4 py-2 text-slate-600">Cloudflare, Inc.</td>
                    <td className="px-4 py-2 text-slate-600">Infrastructure, database, CDN, DDoS protection</td>
                    <td className="px-4 py-2 text-slate-600">Global edge (replicated)</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 text-slate-600">Resend, Inc.</td>
                    <td className="px-4 py-2 text-slate-600">Transactional email delivery</td>
                    <td className="px-4 py-2 text-slate-600">United States</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 text-slate-600">Stripe, Inc.</td>
                    <td className="px-4 py-2 text-slate-600">Subscription billing and payment processing</td>
                    <td className="px-4 py-2 text-slate-600">United States</td>
                  </tr>
                </tbody>
              </table>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">8. Your Rights (DPDP Act, 2023)</h2>
            <p className="text-slate-600 mb-2">
            ...
            <p className="text-slate-600 mt-2">
              To exercise any of these rights, email <a href="mailto:privacy@parkkal.com" className="text-blue-600 hover:underline">privacy@parkkal.com</a>.
              We will respond within 30 days.
            </p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">9. Cross-Border Data Transfers</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">10. Cookies</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">11. Data Breach Notification</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">12. Changes to This Policy</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">13. Contact</h2>
            <p className="text-slate-600">
              Data Protection Officer / Grievance Officer<br />
              Parkkal<br />
              Email: <a href="mailto:privacy@parkkal.com" className="text-blue-600 hover:underline">privacy@parkkal.com</a>
            </p>
          </section>

        </div>

        <div className="mt-10 pt-6 border-t border-slate-100 text-xs text-slate-400 flex gap-6">
          <Link href="/legal/terms" className="hover:text-slate-600">Terms of Service</Link>
          <Link href="/legal/dpa/v1" className="hover:text-slate-600">Data Processing Agreement</Link>
        </div>
      </div>
    </div>
  );
