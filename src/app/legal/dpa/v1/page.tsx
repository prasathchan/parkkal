  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <h1 className="text-3xl font-bold text-pk-text mb-2">Data Processing Agreement</h1>
        ...
        <div className="prose prose-slate max-w-none text-sm leading-relaxed space-y-6">
          ...
          <section>
            <h2 className="text-base font-semibold text-pk-text mb-2">2. Scope and Purpose</h2>
            <p className="text-pk-text-secondary">
          ...
          <section>
            <h2 className="text-base font-semibold text-pk-text mb-2">3. Obligations of the Data Fiduciary (Clinic)</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-pk-text mb-2">4. Obligations of Parkkal (Data Processor)</h2>
            <ul className="list-disc pl-5 text-pk-text-secondary space-y-1">
          ...
          <section>
            <h2 className="text-base font-semibold text-pk-text mb-2">5. Data Retention</h2>
            <p className="text-pk-text-secondary">
          ...
          <section>
            <h2 className="text-base font-semibold text-pk-text mb-2">6. Right to Erasure</h2>
            <p className="text-pk-text-secondary">
          ...
          <section>
            ...
            <p className="text-pk-text-secondary">
              ...
              published at{" "}<a href="/legal/privacy" className="text-pk-teal-600 hover:underline">parkkal.com/legal/privacy</a>.
            </p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-pk-text mb-2">8. Governing Law</h2>
            <p className="text-pk-text-secondary">
          ...
          <section>
            <h2 className="text-base font-semibold text-pk-text mb-2">9. Contact</h2>
            <p className="text-pk-text-secondary">
        ...
        <div className="mt-10 pt-6 border-t border-pk-border flex justify-between items-center">
