    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-slate max-w-none text-sm leading-relaxed space-y-8">
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">3. Account Registration</h2>
            <ul className="list-disc pl-5 text-slate-600 space-y-1">
              <li>You must provide accurate and complete information when registering.</li>
              <li>You are responsible for maintaining the confidentiality of your credentials.</li>
              <li>You must immediately notify us at <a href="mailto:support@parkkal.com" className="text-blue-600 hover:underline">support@parkkal.com</a> of any unauthorised use of your account.</li>
              <li>One organisation account per dental clinic. Creating duplicate accounts to circumvent limits is prohibited.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">4. Subscription and Payment</h2>
            <ul className="list-disc pl-5 text-slate-600 space-y-1">
              ...
              <li>Payments are processed by Stripe. By subscribing, you agree to Stripe&rsquo;s <a href="https://stripe.com/en-in/legal" className="text-blue-600 hover:underline" target="_blank" rel="noreferrer">Terms of Service</a>.</li>
          ...
          <section>
            ...
            <p className="text-slate-600 mb-2">You agree <strong>not</strong> to:</p>
            <ul className="list-disc pl-5 text-slate-600 space-y-1">
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">6. Patient Data and DPDP Compliance</h2>
            <p className="text-slate-600">
            ...
            <p className="text-slate-600 mt-2">
              ...
              <Link href="/legal/dpa/v1" className="text-blue-600 hover:underline">Data Processing Agreement</Link>,
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">8. Availability and Uptime</h2>
            <p className="text-slate-600">
              ...
              <Link href="/status" className="text-blue-600 hover:underline">parkkal.com/status</Link>.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">10. Indemnification</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">11. Termination</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">12. Governing Law and Disputes</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">13. Changes to These Terms</h2>
            <p className="text-slate-600">
          ...
          <section>
            <h2 className="text-base font-semibold text-slate-800 mb-2">14. Contact</h2>
            <p className="text-slate-600">
              Parkkal<br />
              Email: <a href="mailto:support@parkkal.com" className="text-blue-600 hover:underline">support@parkkal.com</a><br />
              For data/privacy matters: <a href="mailto:privacy@parkkal.com" className="text-blue-600 hover:underline">privacy@parkkal.com</a>
            </p>
          </section>
        ...
        <div className="mt-10 pt-6 border-t border-slate-100 text-xs text-slate-400 flex gap-6">
          <Link href="/legal/privacy" className="hover:text-slate-600">Privacy Policy</Link>
