...
export default function Error({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-pk-surface-raised">
      <div className="bg-pk-surface rounded-xl border border-pk-border shadow-sm p-8 max-w-md w-full text-center">
        ...
        <button
          onClick={reset}
          className="inline-flex items-center justify-center px-4 py-2 bg-pk-teal-600 text-white text-sm font-medium rounded-lg hover:bg-pk-teal-700 transition"
        >
          Try again
        </button>
      </div>
