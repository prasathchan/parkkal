    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-6 py-3 border-b border-pk-border bg-pk-surface flex-wrap">
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 rounded-pk-sm border border-pk-border px-3 py-2 text-sm font-medium text-pk-text-secondary hover:bg-pk-surface-raised transition"
        >
          <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
