...
const STATUS_STYLE: Record<AppointmentStatus, { bg: string; text: string; border: string; bar: string; label: string }> = {
  SCHEDULED:   { bg: "bg-blue-50",    text: "text-blue-800",    border: "border-blue-200",   bar: "bg-blue-400",    label: "Scheduled"    },
  CONFIRMED:   { bg: "bg-indigo-50",  text: "text-indigo-800",  border: "border-indigo-200", bar: "bg-indigo-500",  label: "Confirmed"    },
  IN_PROGRESS: { bg: "bg-amber-50",   text: "text-amber-800",   border: "border-amber-200",  bar: "bg-amber-400",   label: "In Progress"  },
  COMPLETED:   { bg: "bg-green-50",   text: "text-green-800",   border: "border-green-200",  bar: "bg-green-500",   label: "Completed"    },
  CANCELLED:   { bg: "bg-gray-100",   text: "text-gray-500",    border: "border-gray-200",   bar: "bg-gray-400",    label: "Cancelled"    },
  NO_SHOW:     { bg: "bg-red-50",     text: "text-red-700",     border: "border-red-200",    bar: "bg-red-500",     label: "No Show"      },
};
