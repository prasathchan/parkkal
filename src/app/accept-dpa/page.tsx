    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm max-w-lg w-full p-8">
        <div className="mb-6">
          ...
          <h1 className="text-xl font-bold text-slate-900 mb-1">Data Processing Agreement</h1>
        ...
        <div className="bg-slate-50 rounded-xl border border-slate-200 p-4 mb-6 text-sm text-slate-600 space-y-2 max-h-48 overflow-y-auto">
          <p className="font-semibold text-slate-800">Summary of Key Terms</p>
          ...
          <p>
            <a href="/legal/dpa/v1" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">
        ...
        <button
          ...
          className="w-full bg-blue-600 text-white rounded-xl py-2.5 text-sm font-semibold hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
